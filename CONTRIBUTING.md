...
- Template sections are based on a core framework such as FastAPI or Django. If it is a template for an ML, Science, Math, etc., add this information to the short description and PR.
